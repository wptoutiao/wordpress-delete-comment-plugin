...
function wptoutiao_wpdcp()
{
	...
	if(isset($_POST['delete_all'])){
		//删除所有评论
		//global $wpdb;
		//$wpdb->delete( $comments_table_name, array( 'comment_approved' => '0' ));
		//$wpdb->delete( $comments_table_name, array( 'comment_approved' => '1' ));
		//$wpdb->delete( $comments_table_name, array( 'comment_approved' => 'spam' ));
		//$wpdb->delete( $comments_table_name, array( 'comment_approved' => 'trash' ));
	}
